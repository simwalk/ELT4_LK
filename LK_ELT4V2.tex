...
\begin{document}
	...
	\input{section/Korrigiert/RecapELT3.tex}
	\input{section/Korrigiert/Grundlagen_der_Frequenzabhängigkeit.tex}
	\input{section/Korrigiert/Schwingkreise.tex}
	\input{section/Korrigiert/RET.tex}
	\input{section/Korrigiert/Leitungen.tex}
	\input{section/Korrigiert/Zweitore.tex}
	\input{section/Korrigiert/EMV.tex}
	
	%Zusätzliche Karten Version 2
	\setcounter{CardID}{100}
	\input{section/Ergänzungen/RecapELT3.tex}
	\input{section/Ergänzungen/Grundlagen_der_Frequenzabhängigkeit.tex}
	\input{section/Ergänzungen/Schwingkreise.tex}
	\input{section/Ergänzungen/RET.tex}
	\input{section/Ergänzungen/Leitungen.tex}
	\input{section/Ergänzungen/Zweitore.tex}
	\input{section/Ergänzungen/EMV.tex}
